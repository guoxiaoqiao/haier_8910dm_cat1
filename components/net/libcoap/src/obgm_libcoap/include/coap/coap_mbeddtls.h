/*
 * coap_mbeddtls.h -- Datagram Transport Layer Support for libcoap
 *
...
struct coap_dtls_context_t *coap_dtls_new_context(void);
...
int coap_dtls_cfg_context(struct coap_context_t *ctx, coap_address_t *addr, void *timer);
